...
func (in *AgentPolicySpec) DeepCopyInto(out *AgentPolicySpec) {
	*out = *in
	...
	if in.AllowedShellCommands != nil {
		in, out := &in.AllowedShellCommands, &out.AllowedShellCommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.DeniedShellCommands != nil {
		in, out := &in.DeniedShellCommands, &out.DeniedShellCommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *AgentTaskSpec) DeepCopyInto(out *AgentTaskSpec) {
	*out = *in
	...
	if in.HierarchyBudget != nil {
		in, out := &in.HierarchyBudget, &out.HierarchyBudget
		*out = new(BudgetSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Resources != nil {
