...
### Critical
- [x] **P0** Replace `resource.MustParse` with `resource.ParseQuantity` — operator panic on invalid input ✅ 2026-02-10 [C2]
- [x] **P0** Pin init container image to `busybox:1.37.0` ✅ 2026-02-10 [C4]
- [x] **P0** Replace shell interpolation in init container with env var approach ✅ 2026-02-10 [M5]
- [x] **P0** Cache ConfigMap in operator — `loadClusterDefaults` fires on every reconcile. Added TTL cache (30s) with mutex. [C1] ✅ 2026-02-10
